module Payday
  ...
  class Invoice
    ...
    attr_accessor :invoice_number, :bill_to, :ship_to, :notes, :line_items, :shipping_rate, :shipping_description,
      :tax_rate, :tax_description, :due_at, :paid_at, :refunded_at, :currency, :invoice_details, :invoice_date, :title
    ...
    def tax_rate=(value)
      @tax_rate = BigDecimal(value&.to_s || '0')
    end

    # Shipping rate
    def shipping_rate=(value)
      @shipping_rate = BigDecimal(value&.to_s || '0')
    end
  end
end
